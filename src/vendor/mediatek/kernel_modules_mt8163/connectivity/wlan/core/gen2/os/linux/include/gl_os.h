...
**
** 08 20 2012 yuche.tsai
** [ALPS00339327][6575JB][BSP Package][Free Test][KE][WIFI]There is no response when you tap the turn off/on
...
struct _GLUE_INFO_T {
	...
	struct ieee80211_channel rScanRequestChannel[MAXIMUM_OPERATION_CHANNEL_LIST];
