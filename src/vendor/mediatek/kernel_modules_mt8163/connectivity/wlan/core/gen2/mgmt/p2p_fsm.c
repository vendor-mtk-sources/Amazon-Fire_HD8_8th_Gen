...
** [ALPS00410124] [Free Test][KE][rlmUpdateParamsForAP]The device reboot automatically
		...
		case OP_MODE_INFRASTRUCTURE:
			{
				...
				kalP2PGCIndicateConnectionStatus(prAdapter->prGlueInfo, NULL, NULL, 0,
					0, WLAN_STATUS_MEDIA_DISCONNECT_LOCALLY);
		...
		case OP_MODE_INFRASTRUCTURE:
			if (authProcessRxDeauthFrame(prSwRfb,
				...
				kalP2PGCIndicateConnectionStatus(prAdapter->prGlueInfo,
								 ...
								 u2ReasonCode, WLAN_STATUS_MEDIA_DISCONNECT);
