 ...
 * [ALPS00235223] [ICS][Cross Feature][AEE-IPANIC]The device reboot automatically and then the "KE" pops up
 ...
 * [WCXRP00000065] Update BoW design and settings
 * [ALPS00118114][ICS][Free Test][Bluetooth]The "KE" pops up after you turn on the airplane mode.(5/5)
 *
 * [Root Cause]
 * PAL operates BOW char dev poll after BOW char dev is registered.
 *
